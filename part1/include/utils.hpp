...
// Convert a string stream of floats to vec3.
glm::vec3 streamToVec3(std::stringstream &stream);
// Convert a string stream of floats to vec2.
glm::vec2 streamToVec2(std::stringstream &stream);

// Get the asset type from filename extension.
AssetType getAssetType(std::filesystem::path filePath);
